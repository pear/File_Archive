...
/**
  ...
  */
class File_Archive_Predicat_MaxDepth extends File_Archive_Predicat
{
    var $maxDepth;
    ...
    /**
      ...
      */
    function File_Archive_Predicat_MaxDepth($maxDepth)
    {
        $this->maxDepth = $maxDepth;
    }
    function isTrue($source)
    {
        return substr_count($source->getFilename(), '/') <= $this->maxDepth ;
    }
}
